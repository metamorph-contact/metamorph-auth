...
describe('authentication fragment parser', () => {
  ...
  it('accepts the exact relay resumption grammar', () => {
    expect(__test.parseFragment('#v=1&operation=01890f3a-6e3a-7c15-8c65-450b85e12a02&resume=aaa.bbb.ccc')).toEqual({
  ...
  it.each([
    ...
    '#v=1&operation=not-a-uuid&resume=aaa.bbb.ccc',
    '#v=1&operation=01890f3a-6e3a-7c15-8c65-450b85e12a02&resume=aaa.bbb.ccc&extra=x',
  ...
  it('consumes a staged relay resumption after URL scrubbing', () => {
    const hash = '#v=1&operation=01890f3a-6e3a-7c15-8c65-450b85e12a02&resume=aaa.bbb.ccc'
    window.history.replaceState(null, '', '/')
    Object.defineProperty(window, '__MM_AUTH_FRAGMENT_V1__', {
      value: hash,
      configurable: true,
    ...
    discardConsumedAuthFragment()
    expect(consumeAuthFragmentOnce()).toEqual({
      kind: 'relayResumption',
      operation: '01890f3a-6e3a-7c15-8c65-450b85e12a02',
      resume: 'aaa.bbb.ccc',
    })
